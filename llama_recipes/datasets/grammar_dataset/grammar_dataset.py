...
class grammar(Dataset):
    def __init__(
        ...
        try:
            ...
            #     delimiter=",",
            # )
            self.dataset = load_dataset('json', data_files=csv_name)
    ...
    def convert_to_features(self, example_batch):
        ...
        input_ = example_batch['conversations'][0]['value']
        target_ = example_batch['conversations'][1]['value']
        ...
        # print('len',len(prompt_ids)+len(label_ids))
